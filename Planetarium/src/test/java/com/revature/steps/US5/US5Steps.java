...
public class US5Steps {
    ...
    public void the_user_gives_data_for_the_planet_they_wish_to_delete(String string) {
    ...
    public void the_user_gives_data_for_the_moon_they_wish_to_delete(String string) {
        // Write code here that turns the phrase above into concrete actions
